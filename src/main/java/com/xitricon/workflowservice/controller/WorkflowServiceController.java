...
public class WorkflowServiceController {
	...
	public ResponseEntity<WorkflowOutputDTO> workflowSubmission(
			@RequestBody WorkflowSubmissionInputDTO workflowSubmissionInput, @RequestParam boolean completed, @RequestParam String tenantId) {
		return ResponseEntity.ok(workflowService.handleWorkflowSubmission(completed, workflowSubmissionInput, tenantId));
	}
